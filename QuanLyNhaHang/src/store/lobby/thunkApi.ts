...
export const getLobbyListReady = createAsyncThunk(
  'lobby/getLobbyListReady',
  async (params: {date?: Date; time?: number}) => {
    const result = await LobbyApi.getLobbyListReady(params);
    return result.data;
  },
);
